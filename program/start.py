        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "‹ لتنصيب بوت ›", url=f"https://t.me/YYIKK"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/78827dfb6a49b1a8ff0f3.jpg",
        caption=f"""Programmer [𝗔𝗛𝗠𝗘𝗗 𝗖𝗛𝗔𝗡𝗡𝗘𝗟](https://t.me/YY8GG) 𖡼 \ Follow our news 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𝗔𝗛𝗠𝗘𝗗 𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url=f"https://t.me/YY8GG"),
            ],
            [
                InlineKeyboardButton(
                    "𝗔𝗛𝗠𝗘𝗗", url=f"https://t.me/YYIKK"
                ),
            ],
            [
